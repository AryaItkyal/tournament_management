...
public class SearchBoxModel extends AbstractListModel<String>
                implements ComboBoxModel<String>, KeyListener, ItemListener
{
    ...
    public SearchBoxModel(JComboBox<String> jcb,ArrayList<String> db )
    {
